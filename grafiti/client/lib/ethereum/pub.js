window.addEventListener('load', function() {
    ...
    function refreshPub() {
        Pub.getAddress(function(address) {
            pub = web3.eth.contract(pubABI).at(address);
            while (onPub.length) {
                onPub.pop()();
            }
        });
    ...
    getAddress: function(resultFn) {
        switch (nId) {
            default:
                ...
                // TODO handle this error, if it ever happens
            case "1":
                return resultFn('0x2a0f713aA953442EacA9EA47083f656170e67BA4');
            case "4":
                console.log("Using Rinkeby");
                return resultFn('0xC68794C3C55e62b4D65291B6E061Ccf5ee678CF5');
        }
    },
    size: function() {
        return pub_size;
